...
**Status: Phase 9 BALANCE PASS IN PROGRESS — scenario harness DONE (`npm run scenarios`) + user interview done (see Phase 9 findings); tuning is next, no balance numbers changed yet** (updated 2026-07-09)
